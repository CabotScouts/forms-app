...
class ActivityNotificationController
{
  ...
  public function submit(Request $request): View|RedirectResponse
  {
    $rules = [
      ...
      'number_squirrels' => ['nullable', 'integer', 'gte:0'],
      'number_beavers' => ['nullable', 'integer', 'gte:0'],
      'number_cubs' => ['nullable', 'integer', 'gte:0'],
      'number_scouts' => ['nullable', 'integer', 'gte:0'],
      'number_explorers' => ['nullable', 'integer', 'gte:0'],
      'number_adults' => ['required', 'integer', 'gte:0'],
