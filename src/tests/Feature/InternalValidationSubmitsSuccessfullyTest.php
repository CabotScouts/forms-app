...
class InternalValidationSubmitsSuccessfullyTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_internal_validation_is_submitted(): void
    {
        ...
        Mail::fake();
        $response = $this->post(route('fa.internal.submit', $data));
        $response->assertStatus(302);

        // 3 - check validation request and upload in DB, and mail was sent
        $this->assertDatabaseHas('first_aid_validations', ['name' => 'John Smith', 'type' => 'internal']);
