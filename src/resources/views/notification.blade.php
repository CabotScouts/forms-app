    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group">
          <label for="lic-name">Name*</label>
          <input type="text" class="form-control" id="lic_name" name="lic-name" value="{{ old('lic-name', $form) }}" required>
        </div>

        <div class="form-group">
          <label for="lic-email">Email Address*</label>
          <input type="email" class="form-control" id="lic-email" name="lic-email" value="{{ old('lic-email', $form) }}" required>
        </div>

        <div class="form-group mb-0">
          <label for="lic-phone">Phone Number*</label>
          <input type="input" class="form-control" id="lic-phone" name="lic-phone" value="{{ old('lic-phone', $form) }}" required>
        </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="submitter-name" name="submitter-name" value="{{ old('submitter-name', $form) }}">
        </div>

        <div class="form-group mb-0">
          <label for="submitter-email">Email Address</label>
          <input type="email" class="form-control" id="submitter-email" name="submitter-email" value="{{ old('submitter-email', $form) }}">
      ...
      <div class="card-body">
        ...
        <div class="form-row">
          <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="group" name="group" value="{{ old('group', $form) }}" required>
              <small class="form-text text-muted">
                Enter <em>14-24</em> for Explorer or Network events, or <em>Programme Team</em> for District-organised events.
              </small>
          </div>

          <div class="form-group col-md-12">
            <label for="section">Section/Explorer Unit/Programme Team*</label>
            <input type="text" class="form-control" id="section" name="section" value="{{ old('section', $form) }}" required>
          </div>
        </div>
        ...
        <small class="form-text text-muted">
          Any Young Leaders attending should be counted in the Explorers column, Networkers should be counted in the adults column.
        </small>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="date" class="form-control" id="date" name="date" value="{{ old('date', $form) }}" required>
        </div>
  ...
  <div class="col mb-2">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">
          Where the activity requires a permit holder or is being lead by an external activity provider, please provide details.
        </p>
        ...
        <div class="form-group mb-0">
          ...
          <input type="email" class="form-control" id="activity-leader-email" name="activity-leader-email" value="{{ old('activity-leader-email', $form) }}">
          <small class="form-text text-muted">
  ...
  <div class="col mb-2">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">You must provide a written risk assessment to cover the aspects of this activity which you are responsible for.</p>

        <div class="form-group mb-0">
          <label for="risk-assessments">Upload Risk Assessments*</label>

          @include('components.filepond', ['id' => 'risk-assessments', 'name' => 'risk-assessments[]', 'required' => true])

          <small class="form-text text-muted">
             Multiple files can be submitted if necessary (maximum 5 files, 3MB per file, accepted filetypes are pdf, doc, docx, xls, xlsx).
    ...
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">
          ...
          <a href="https://www.scouts.org.uk/volunteers/running-your-section/programme-guidance/information-for-volunteers/intouch/" target="_blank" rel="nofollow noreferer">
            Read more about InTouch procedures.</a>
        </p>

        <div class="form-group mb-0">
          <label for="intouch">Activity InTouch Arrangements*</label>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">
          ...
          or District Programme Team Leader (for Programme Team organised activities) must be aware this activity is taking place.
        </p>

        <div class="form-group mb-0">
          <label for="team-leader-email">GLV/Team Leader Email*</label>
          <input type="email" class="form-control" id="team-leader-email" name="team-leader-email" value="{{ old('team-leader-email', $form) }}" required>
          <small class="form-text text-muted">
